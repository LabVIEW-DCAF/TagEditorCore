...
<Library LVVersion="13008000">
	...
	<Item Name="tarcfg" Type="Folder">
		<Item Name="tarcfg serialize test.vi" Type="VI" URL="../tarcfg serialize test.vi"/>
	</Item>
	<Item Name="testmod" Type="Folder">
		<Item Name="TEST CONFIGURATION.lvclass" Type="LVClass" URL="../test module/module/configuration/TEST CONFIGURATION.lvclass"/>
		<Item Name="TEST EDITOR.lvclass" Type="LVClass" URL="../test module/editor node/TEST EDITOR.lvclass"/>
