...
<Project Type="Project" LVVersion="14008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Tests" Type="Folder">
			<Item Name="Table Manager tests.lvlib" Type="Library" URL="../Test Vis/testing/Table Manager tests.lvlib"/>
			<Item Name="tag bus configurable plugin editor node.lvclass" Type="LVClass" URL="../Test Vis/editor node/tag bus configurable plugin editor node.lvclass"/>
			<Item Name="tag bus configurable plugin module configuration.lvclass" Type="LVClass" URL="../Test Vis/module/configuration/tag bus configurable plugin module configuration.lvclass"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Format Numeric String.vi" Type="VI" URL="../Helpers/Format Numeric String.vi"/>
			...
			<Item Name="tag bus configurable plugin module.lvclass" Type="LVClass" URL="../Test Vis/module/execution/tag bus configurable plugin module.lvclass"/>
