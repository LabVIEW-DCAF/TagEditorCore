...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="processing plugin tests.lvlib" Type="Library" URL="../testing/processing plugin tests.lvlib"/>
		<Item Name="tag bus processing plugin editor node.lvclass" Type="LVClass" URL="../editor node/tag bus processing plugin editor node.lvclass"/>
		<Item Name="tag bus processing plugin module configuration.lvclass" Type="LVClass" URL="../module/configuration/tag bus processing plugin module configuration.lvclass"/>
		<Item Name="tag bus processing plugin module.lvclass" Type="LVClass" URL="../module/execution/tag bus processing plugin module.lvclass"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="tag editor.xctl" Type="XControl" URL="../../../../../tag editor xctl/tag editor.xctl"/>
		</Item>
